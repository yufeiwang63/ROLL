...
class ObsDictRelabelingBuffer(ReplayBuffer):
    ...
    def __init__(
        ...
        # print("=" * 50, "online vae replay buffer goal_keys are: ", self.goal_keys)
    ...
    def add_path(self, path):
        ...
        assert path_len == self.max_path_length, "for now we only support for ecah path to have the same length!"
        ...
        self._traj_num = int(self._size / path_len) # NOTE yufei: assuma all trajectories has the same length!!
    ...
    def random_batch(self, batch_size):
        ...
        if num_env_goals > 0:
            ...
            # print("self.goal_keys in obs_dict_replay_buffer: ", self.goal_keys)
        ...
        # print("self.desired_goal_key: ", self.desired_goal_key)
        # print("self.achieved_goal_key: ", self.achieved_goal_key)
        # exit()
        ...
        if hasattr(self.env, 'compute_rewards'):
            # print("=" * 50, "online vae replay buffer random_batch, calls self.env.compute_rewards")
        ...
        # print("self.observation_key: ", self.observation_key)
        # exit()
