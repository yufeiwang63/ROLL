...
class OnlineVaeRelabelingBufferSegmented(SharedObsDictRelabelingBuffer):
    ...
    def __init__(
        ...
        assert isinstance(self.env, VAEWrappedEnvSegmented)
        self.vae = vae_ori
        self.vae_seg = vae_seg
    ...
    def add_decoded_vae_goals_to_path(self, path):
        ...
        desired_decoded_goals = self.env._decode(desired_goals, self.env.vae_segmented)
    ...
    def sample_weighted_indices(self, batch_size, key=None):
