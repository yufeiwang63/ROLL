...
def register_mujoco_envs():
    ...
    register(
        id='SawyerPushNIPSPuckInvisible-v0',
        entry_point='multiworld.envs.mujoco.sawyer_xyz'
                    '.sawyer_push_nips:SawyerPushAndReachXYEasyEnv_PuckInvisible',
        kwargs=dict(
            hide_goal=True,
            reward_info=dict(
                type="state_distance",
    ...
    register(
        id='SawyerPushNIPSFull-v0',
        entry_point='multiworld.envs.mujoco.sawyer_xyz'
                    '.sawyer_push_nips:SawyerPushAndReachXYFullEnv',
        tags={
            'git-commit-hash': 'b5cac93',
            'author': 'murtaza',
        },
    ...
    register(
        id='SawyerDoorHookResetFreeEnvDoorInvisible-v0',
        entry_point='multiworld.envs.mujoco.sawyer_xyz'
                    '.sawyer_door_hook:SawyerDoorHookEnv',
        tags={
            'git-commit-hash': '15b48d5',
        ...
        kwargs=dict(
            ...
            max_angle=.83,
            # xml_path='sawyer_xyz/sawyer_door_pull_hook.xml',
            xml_path='sawyer_xyz/sawyer_door_pull_hook_door_invisible.xml',
            reward_type='angle_diff_and_hand_distance',
            reset_free=True,
        )
    )
    ...
    register(
        id='SawyerDoorHookResetFreeEnvRobotInvisible-v0',
        entry_point='multiworld.envs.mujoco.sawyer_xyz'
                    '.sawyer_door_hook:SawyerDoorHookEnv',
        tags={
            'git-commit-hash': '15b48d5',
        ...
        kwargs=dict(
            ...
            hand_high=(0.05, 0.65, .25),
            max_angle=.83,
            xml_path='sawyer_xyz/sawyer_door_pull_hook_robot_invisible.xml',
            reward_type='angle_diff_and_hand_distance',
            reset_free=True,
        )
    )
    ...
    register(
        id='SawyerDoorHookResetFreeEnvDoorAndRobotInvisible-v0',
        entry_point='multiworld.envs.mujoco.sawyer_xyz'
                    '.sawyer_door_hook:SawyerDoorHookEnv',
        tags={
            'git-commit-hash': '15b48d5',
        ...
        kwargs=dict(
            ...
            max_angle=.83,
            # xml_path='sawyer_xyz/sawyer_door_pull_hook.xml',
            xml_path='sawyer_xyz/sawyer_door_pull_hook_door_and_robot_invisible.xml',
            reward_type='angle_diff_and_hand_distance',
            reset_free=True,
        )
    )
    ...
    register(
        id='SawyerPickupResetFreeEnvBallInvisible-v0',
        entry_point='multiworld.envs.mujoco.sawyer_xyz'
                    '.sawyer_pick_and_place:SawyerPickAndPlaceEnv',
        tags={
            'git-commit-hash': '30f23f7',
    ...
    register(
        id='SawyerPickupResetFreeEnvBallAndRobotInvisible-v0',
        entry_point='multiworld.envs.mujoco.sawyer_xyz'
                    '.sawyer_pick_and_place:SawyerPickAndPlaceEnv',
        tags={
            'git-commit-hash': '30f23f7',
    ...
    register(
        id='SawyerPushTPuckInvisible-v0',
        entry_point='multiworld.envs.mujoco.sawyer_xyz'
                    '.sawyer_push_T:SawyerPushAndReachTXYEasyEnv_PuckInvisible',
        tags={
            'git-commit-hash': 'b8d77fef5f3ebe4c1c9c3874a5e3faaab457a350',
            'author': 'steven',
        },
    ...
    register(
        ...
        kwargs=dict(
            ...
            hand_goal_low=(-0.03, 0.54),
            hand_goal_high=(0.0, 0.6),
    ...
    register(
        id='SawyerPushHurdlePuckInvisible-v0',
        entry_point='multiworld.envs.mujoco.sawyer_xyz'
                    '.sawyer_push_hurdle:SawyerPushAndReachHurdleXYEasyEnv_PuckInvisible',
        tags={
            'git-commit-hash': 'b8d77fef5f3ebe4c1c9c3874a5e3faaab457a350',
            'author': 'steven',
        },
    ...
    register(
        id='SawyerPushHurdlePuckAndRobotInvisible-v0',
        entry_point='multiworld.envs.mujoco.sawyer_xyz'
                    '.sawyer_push_hurdle:SawyerPushAndReachHurdleXYEasyEnv_PuckAndRobotInvisible',
        tags={
            'git-commit-hash': 'b8d77fef5f3ebe4c1c9c3874a5e3faaab457a350',
            'author': 'steven',
        },
    ...
    register(
        id='SawyerPushHurdleMiddlePuckInvisible-v0',
        entry_point='multiworld.envs.mujoco.sawyer_xyz'
                    '.sawyer_push_hurdle_middle:SawyerPushAndReachHurdleMiddleXYEasyEnv_PuckInvisible',
        tags={
            'git-commit-hash': 'b8d77fef5f3ebe4c1c9c3874a5e3faaab457a350',
            'author': 'steven',
        },
    ...
    # hurlde reset free
    register(
        id='SawyerPushHurdleResetFreeEnv-v0',
        entry_point='multiworld.envs.mujoco.sawyer_xyz'
                    '.sawyer_push_hurdle_reset_free:SawyerPushAndReachHurdleXYResetFreeEasyEnv',
        tags={
            'git-commit-hash': 'b8d77fef5f3ebe4c1c9c3874a5e3faaab457a350',
            'author': 'steven',
        },
        kwargs=dict(
            force_puck_in_goal_space=False,
            mocap_low=(-0.1, 0.52, 0.0),
            mocap_high=(0.15, 0.7, 0.5),
            hand_goal_low=(-0.1, 0.52),
            hand_goal_high=(0.15, 0.7),
            puck_goal_low=(-0.07, 0.55),
            puck_goal_high=(0.12, 0.66),
    ...
    register(
        id='SawyerPushHurdleResetFreePuckInvisibleEnv-v0',
        entry_point='multiworld.envs.mujoco.sawyer_xyz'
                    '.sawyer_push_hurdle_reset_free:SawyerPushAndReachHurdleXYResetFreeEasyEnv_PuckInvisible',
        tags={
            'git-commit-hash': 'b8d77fef5f3ebe4c1c9c3874a5e3faaab457a350',
            'author': 'steven',
        },
