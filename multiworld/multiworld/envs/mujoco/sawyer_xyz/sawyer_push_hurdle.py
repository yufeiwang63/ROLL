...
class SawyerPushAndReachHurdleXYEnv(MujocoEnv, Serializable, MultitaskEnv):
    ...
    def __init__(
        ...
        self.puckAndRobotInvisible = puckAndRobotInvisible
...
class SawyerPushAndReachHurdleXYEasyEnv_PuckInvisible(SawyerPushAndReachHurdleXYEnv):
    """
    Always start the block in the same position, and use a 40x20 puck space
    """
...
class SawyerPushAndReachHurdleXYEasyEnv_PuckAndRobotInvisible(SawyerPushAndReachHurdleXYEnv):
    """
    Always start the block in the same position, and use a 40x20 puck space
    """
