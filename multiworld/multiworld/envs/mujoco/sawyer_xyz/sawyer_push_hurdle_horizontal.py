...
class SawyerPushAndReachHurdleHorizontalXYEnv(MujocoEnv, Serializable, MultitaskEnv):
    INIT_HAND_POS = np.array([0., 0.45, 0.02])
    ...
    def __init__(
            ...
            hide_goal=False,
            init_block_low=(0.01, 0.55),
            init_block_high=(0.03, 0.55),
...
class SawyerPushAndReachHurdleHorizontalXYEasyEnv(SawyerPushAndReachHurdleHorizontalXYEnv):
    """
    ...
    def __init__(
        ...
        SawyerPushAndReachHurdleHorizontalXYEnv.__init__(
            self,
            **actual_kwargs
        )
...
class SawyerPushAndReachHurdleHorizontalXYHarderEnv(SawyerPushAndReachHurdleHorizontalXYEnv):
    """
